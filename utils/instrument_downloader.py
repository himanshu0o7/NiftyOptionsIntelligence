...
class InstrumentDownloader:
    ...
    def download_and_process(self) -> bool:
        ...
        try:
            ...
            df['strike'] = (pd.to_numeric(df['strike'], errors='coerce') / 100).astype(int)
